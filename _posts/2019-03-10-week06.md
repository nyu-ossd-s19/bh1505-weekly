...
__Are these instructions clear? Do you think they would be easy to follow?__ Yes and Yes
...
- __are there issues marked "documentation" or some other indicators that imply that they are documentation (user or developer specific):__ Yes.
    ...
    - __how many of such issues are there?__ 10 open, 79 closed
    
    - __look at a few of them, do you think you could submit a fix?__ Yes, some fixes are very minor.
...
- __how many open pull requests are there:__ 8
    ...
    - __when was the last pull request made:__ January 12, 2019

    - __url for the oldest pull request created:__ https://github.com/rapidsms/rapidsms/pull/315
    
    - __when was the oldest pull request made:__ March 12, 2013
...
- __how many closed pull requests are there:__ 183
    ...
    - __when was the pull request made:__ December 27, 2018
    
    - __when was the pull request closed:__ December 27, 2018
    

- __do maintainers respond quickly to pull requests when they are opened?__ They tend to be slow at responding, taking months at times.
...
## Summary assesment
__How friendly is this project for beginner contributors?__ Not so friendly. There isn't any "beginner" labeled issues and contributing to the code involves a lot of steps and standards to follow. Submitting a documentation contribution would not be as difficult, however, the maintainers are slow to respond.

__Do the maintainers respond helpfully to questions in issues?__ Yes, they are just slow to respond sometimes.
